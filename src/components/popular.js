...
const Popular = React.memo((props) => {
    ...
    return(
        <Grid cursor='pointer' onClick={()=>{navigate(`/postdetail/${props.postKey}`)}} position='relative' borderRadius='5px' width='90%' height='130px' is_flex flexDirection='column' alignItems='center'>
